...
export default function Dashboard() {
  ...
  const origemColors = { YouTube: "#ef4444", Indicação: "#10b981", Instagram: "#8b5cf6", Google: "#3b82f6", "Não definida": "#94a3b8" };
  return (
          ...
          <div style={styles.stageRow}>
            {countByStage.map((s) => (
              <button
                ...
                style={{
                  ...styles.stageCard,
                  borderColor: filtroEstágio === s.id ? s.color : "#e5e7eb",
                  background: filtroEstágio === s.id ? `${s.color}12` : "#ffffff",
                }}
              >
            ...
            <table style={styles.table}>
              ...
              <tbody>
                    ...
                    <tr key={lead.id} style={styles.tr}>
                      ...
                      <td style={styles.td}>
                        <div style={styles.stageTagRow}>
                          ...
                          <span style={{ ...styles.stageTag, color: stage.color, background: `${stage.color}15` }}>{stage.label}</span>
                        </div>
                      </td>
                ...
                {leadsFiltered.length === 0 && (
                  <tr><td colSpan={5} style={{ ...styles.td, textAlign: "center", color: "#94a3b8", padding: 32 }}>Nenhum lead neste filtro</td></tr>
                )}
              </tbody>
            </table>
          </div>
        ...
        <>
          ...
          <div style={styles.reportRow}>
            <div style={styles.reportCard}>
              ...
              {origemList.length === 0 && <p style={{ color: "#94a3b8", fontSize: 13, margin: 0 }}>Nenhuma origem registrada ainda.</p>}
...
const styles = {
  ...
  title: { fontSize: 24, fontWeight: 700, color: "#1f2937", margin: 0, letterSpacing: "-0.5px" },
  subtitle: { fontSize: 12, color: "#6b7280", margin: "4px 0 0" },
  center: { textAlign: "center", padding: 48, color: "#6b7280", fontSize: 14 },
  rangeRow: { display: "flex", gap: 3, background: "#e5e7eb", borderRadius: 7, padding: 2 },
  ...
  rangeBtnActive: { background: "#ffffff", color: "#1f2937", boxShadow: "0 1px 2px rgba(0,0,0,0.08)" },
  tabRow: { display: "flex", gap: 3, background: "#e5e7eb", borderRadius: 7, padding: 2 },
  ...
  stageDesc: { fontSize: 10, color: "#6b7280" },
  funnelContainer: { display: "flex", alignItems: "center", gap: 12, marginBottom: 20 },
  funnelLabel: { fontSize: 10, color: "#6b7280", textTransform: "uppercase", letterSpacing: 1, minWidth: 36 },
  funnelBar: { flex: 1, height: 7, borderRadius: 4, background: "#e5e7eb", display: "flex", overflow: "hidden", gap: 2 },
  funnelConv: { fontSize: 11, color: "#10b981", fontWeight: 600, minWidth: 80, textAlign: "right" },
  tableContainer: { background: "#ffffff", borderRadius: 10, overflow: "auto", border: "1px solid #e5e7eb", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" },
  table: { width: "100%", borderCollapse: "collapse", minWidth: 600 },
  th: { fontSize: 10, fontWeight: 600, color: "#6b7280", textTransform: "uppercase", letterSpacing: 0.8, padding: "10px 14px", textAlign: "left", borderBottom: "1px solid #e5e7eb", whiteSpace: "nowrap" },
  ...
  contactName: { fontWeight: 600, color: "#1f2937", fontSize: 13 },
  contactPhone: { fontSize: 11, color: "#94a3b8" },
  dateTag: { fontSize: 12, color: "#6b7280" },
  ...
  origemTag: { fontSize: 11, fontWeight: 500, color: "#6b7280", background: "#f3f4f6", padding: "2px 7px", borderRadius: 5 },
  kpiRow: { display: "flex", gap: 10, marginBottom: 20, flexWrap: "wrap" },
  kpiCard: { flex: "1 1 150px", background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 10, padding: "16px 16px 14px", display: "flex", flexDirection: "column", gap: 3, position: "relative", overflow: "hidden", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" },
  kpiAccent: { position: "absolute", top: 0, left: 0, right: 0, height: 3 },
  kpiLabel: { fontSize: 10, color: "#6b7280", textTransform: "uppercase", letterSpacing: 0.8, marginTop: 3 },
  ...
  reportCard: { flex: "1 1 280px", background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 10, padding: 18, boxShadow: "0 1px 3px rgba(0,0,0,0.04)" },
  reportTitle: { fontSize: 13, fontWeight: 600, color: "#1f2937", margin: "0 0 14px" },
  origemRow: { marginBottom: 12 },
  origemRowTop: { display: "flex", justifyContent: "space-between", marginBottom: 5 },
  origemName: { fontSize: 12, color: "#4b5563", fontWeight: 500 },
  origemPct: { fontSize: 11, fontWeight: 600 },
  barBg: { height: 5, background: "#e5e7eb", borderRadius: 4, overflow: "hidden" },
  alertBox: { display: "flex", gap: 9, alignItems: "flex-start", marginTop: 16, background: "#fffbeb", border: "1px solid #fde68a", borderRadius: 7, padding: "9px 11px" },
  alertIcon: { fontSize: 15, flexShrink: 0 },
  alertTitle: { display: "block", fontSize: 12, fontWeight: 600, color: "#d97706" },
  alertDesc: { display: "block", fontSize: 10, color: "#94a3b8", marginTop: 1 },
  resumoCard: { background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 10, padding: 20, boxShadow: "0 1px 3px rgba(0,0,0,0.04)" },
  resumoText: { fontSize: 13, color: "#4b5563", lineHeight: 1.7, margin: 0 },
};
